...
if(isset($_POST['em'])){
    ...
    if($result){
        echo'<script>alert("Subscribe successfully!")
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="position-relative mx-auto" style="max-width: 400px;">
                        ...
                        <button class="btn btn-primary w-100 py-3" name="em" type="submit">Subscribe</button>
                    </div>
                </div>
                </form>
            </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="index.php">Shreeji Furniture</a>, All Right Reserved.
                    </div>
